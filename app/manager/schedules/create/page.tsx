...
export default async function CreateSchedulePage() {
    ...
    const [employees, departmentsResult, locations, teamsResult] = await Promise.all([
        getAllTeamMembers(),
        getDepartments(),
            ...
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-gray-600">
                        Unable to load required data for schedule creation.
                    </p>
                </div>
            </div>
        )
                    ...
                    <div className="flex items-center justify-between h-16">
                        <div className="flex items-center space-x-4">
                            ...
                            <h1 className="text-xl font-semibold text-gray-900 flex items-center">
                                <CalendarPlusIcon className="h-5 w-5 mr-2 text-blue-600" />
                                Create Schedule
                            </h1>
                        </div>
                    </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <p className="text-sm text-gray-600">
                            Create a new schedule for your team. Fill in the details below and assign it to employees, departments, or locations.
                        </p>
                    </CardHeader>
                    <CardContent>
                        <CreateScheduleForm
